 ...
 *     -s WASM=1 \
 *     -s EXPORTED_FUNCTIONS='["_prepare","_reset","_destroy","_process","_set_rate","_get_rate","_set_depth","_get_depth","_set_manual","_get_manual","_set_feedback","_get_feedback","_set_waveform","_get_waveform","_set_spread","_get_spread","_set_mix","_get_mix"]' \
