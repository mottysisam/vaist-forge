 ...
 *     -s WASM=1 \
 *     -s EXPORTED_FUNCTIONS='["_prepare","_reset","_destroy","_process","_set_rate","_get_rate","_set_depth","_get_depth","_set_manualDelay","_get_manualDelay","_set_feedback","_get_feedback","_set_lfoWaveform","_get_lfoWaveform","_set_stereoPhase","_get_stereoPhase","_set_stereoWidth","_get_stereoWidth","_set_highpassFreq","_get_highpassFreq","_set_lowpassFreq","_get_lowpassFreq","_set_mix","_get_mix","_set_outputGain","_get_outputGain"]' \
...
void set_manualDelay(float value) {
    g_processor.set_manualDelay(value);
}
...
void set_lfoWaveform(float value) {
    g_processor.set_lfoWaveform(value);
}

EMSCRIPTEN_KEEPALIVE
void set_stereoPhase(float value) {
    g_processor.set_stereoPhase(value);
}

EMSCRIPTEN_KEEPALIVE
void set_stereoWidth(float value) {
    g_processor.set_stereoWidth(value);
}

EMSCRIPTEN_KEEPALIVE
void set_highpassFreq(float value) {
    g_processor.set_highpassFreq(value);
}

EMSCRIPTEN_KEEPALIVE
void set_lowpassFreq(float value) {
    g_processor.set_lowpassFreq(value);
}
...
void set_outputGain(float value) {
    g_processor.set_outputGain(value);
}
...
EMSCRIPTEN_KEEPALIVE
float get_manualDelay() {
    return g_processor.get_manualDelay();
}
...
EMSCRIPTEN_KEEPALIVE
float get_lfoWaveform() {
    return g_processor.get_lfoWaveform();
}

EMSCRIPTEN_KEEPALIVE
float get_stereoPhase() {
    return g_processor.get_stereoPhase();
}

EMSCRIPTEN_KEEPALIVE
float get_stereoWidth() {
    return g_processor.get_stereoWidth();
}

EMSCRIPTEN_KEEPALIVE
float get_highpassFreq() {
    return g_processor.get_highpassFreq();
}

EMSCRIPTEN_KEEPALIVE
float get_lowpassFreq() {
    return g_processor.get_lowpassFreq();
}
...
float get_outputGain() {
    return g_processor.get_outputGain();
}
