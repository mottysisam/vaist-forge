 ...
 *     -s WASM=1 \
 *     -s EXPORTED_FUNCTIONS='["_prepare","_reset","_destroy","_process","_set_rate","_get_rate","_set_depth","_get_depth","_set_feedback","_get_feedback","_set_manualDelay","_get_manualDelay","_set_lfoWaveform","_get_lfoWaveform","_set_stereoPhase","_get_stereoPhase","_set_mix","_get_mix","_set_outputGain","_get_outputGain"]' \
