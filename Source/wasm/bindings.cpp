 ...
 *     -s WASM=1 \
 *     -s EXPORTED_FUNCTIONS='["_prepare","_reset","_destroy","_process","_set_rate","_get_rate","_set_depth","_get_depth","_set_manual","_get_manual","_set_feedback","_get_feedback","_set_waveform","_get_waveform","_set_offset","_get_offset","_set_mix","_get_mix"]' \
...
void set_waveform(float value) {
    g_processor.set_waveform(value);
}

EMSCRIPTEN_KEEPALIVE
void set_offset(float value) {
    g_processor.set_offset(value);
}
...
EMSCRIPTEN_KEEPALIVE
float get_waveform() {
    return g_processor.get_waveform();
}

EMSCRIPTEN_KEEPALIVE
float get_offset() {
    return g_processor.get_offset();
}
